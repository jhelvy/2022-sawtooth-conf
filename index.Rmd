...
# .center[Make a D-efficient design (coming soon!)]
...
## - Import a design: .darkblue[Sawtooth] `r fa("arrow-right")` `r fa("file-csv", fill = "darkgreen")` `r fa("arrow-right")` `r fa("r-project", fill = "darkblue")`
