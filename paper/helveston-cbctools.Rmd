...
```{r, echo=FALSE, fig.align='center', fig.cap="Caption", out.width="75%"}
knitr::include_graphics("figs/tradeoffs.png")
```
...
```{r, echo=FALSE, fig.align='center', fig.cap="Caption", out.width="100%"}
